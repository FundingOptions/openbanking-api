...
class OpenBankingApi:
    ...
    def get_api_data(self, endpoint, bank):
    ...
    def unsecured_sme_loans(self, bank):
        return self.get_api_data('unsecured-sme-loans', bank)

    def business_current_accounts(self, bank):
        return self.get_api_data('business-current-accounts', bank)

    def commercial_credit_cards(self, bank):
        return self.get_api_data('commercial-credit-cards', bank)
